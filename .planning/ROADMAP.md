...
- [x] 06-05-PLAN.md — Cut public/owner consumers over to ordered images and protected lifecycle
- [x] 06-06-PLAN.md — Run automated, hosted, responsive, and browser acceptance gates
